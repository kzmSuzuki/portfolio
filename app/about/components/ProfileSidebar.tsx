...
少しでも興味を持っていただければ幸いです。`,
    ...
    skills: [
      { name: "HTML5", icon: "html5", type: "plain" },
      { name: "CSS3", icon: "css3", type: "plain" },
      { name: "JavaScript", icon: "javascript", type: "plain" },
      { name: "TypeScript", icon: "typescript", type: "plain" },
      { name: "React", icon: "react", type: "plain" },
      { name: "Next.js", icon: "nextjs", type: "plain" },
      { name: "Node.js", icon: "nodejs", type: "plain" },
      { name: "express", icon: "express", type: "original" },
      { name: "PostgreSQL", icon: "postgresql", type: "plain" },
      { name: "prisma", icon: "prisma", type: "original" },
      { name: "firebase", icon: "firebase", type: "plain" },
      { name: "Python", icon: "python", type: "plain" },
      { name: "C", icon: "c", type: "plain" },
    ...
    <aside className={styles.sidebar}>
      <div className={styles.topSection}>
        <div className={styles.avatarColumn}>
          <img src="portrait.webp" alt="Portrait" className={styles.avatar} />
        </div>
        <div className={styles.skillsColumn}>
          ...
          <div className={styles.skillsGrid}>
            {profileData.skills.map((skill, index) => (
              <i
                key={index}
                className={`devicon-${skill.icon}-${skill.type} ${styles.skillIcon}`}
                title={skill.name}
              ></i>
            ))}
          </div>
